...
def test_2026_team_id_overrides_unstable_display_name():
    assert normalize_team_name("Red Bull", year=2026, team_id="red_bull") == "Red Bull Racing"
    assert normalize_team_name("RB F1 Team", year=2026, team_id="rb") == "Racing Bulls"
    assert normalize_team_name("Alpine F1 Team", year=2026, team_id="alpine") == "Alpine"
    assert normalize_team_name("Cadillac F1 Team", year=2026, team_id="cadillac") == "Cadillac"
...
def test_2026_team_id_map_has_exactly_the_current_grid():
    ...
    names = {
        normalize_team_name(team_id, year=2026, team_id=team_id)

...
MIN_DELAY_HOURS = 1
MAX_DELAY_HOURS = 72  # catch sessions FastF1 published late (practice can take hours/days)
...
def is_race_weekend(schedule, now):
    ...
    for _, event in schedule.iterrows():
        ...
        weekend_end = race_date + timedelta(hours=race_duration + 72)  # 72h trailing window for late/missed sessions

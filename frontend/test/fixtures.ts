...
/** The race classification the podium and the Clutch script read. */
export const raceClassification = {
  session: {
    id: 1,
    year: FIXTURE_SEASON,
    round: FIXTURE_ROUND,
    session_type: "race",
    event_name: latestRound.event_name,
  ...
  results: [
    {
      ...
      status: "Finished",
      headshot_url: null,
      driver: { driver_code: "VER", full_name: "Max Verstappen" },
      team: { team_name: "Red Bull Racing", team_color: "3671C6" },
      grid_position: 4,
      points: 25,
      laps_completed: 53,
      time_seconds: 5400.25,
    ...
    },
    {
      ...
      status: "Finished",
      headshot_url: null,
      driver: { driver_code: "HAM", full_name: "Lewis Hamilton" },
      team: { team_name: "Ferrari", team_color: "E8002D" },
      grid_position: 1,
      points: 18,
      laps_completed: 53,
      time_seconds: 3.857,

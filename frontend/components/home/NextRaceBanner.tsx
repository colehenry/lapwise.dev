...
import { ConcentricPattern, GridPattern } from "@/components/layout/Patterns";
...
export default function NextRaceBanner() {
  ...
  return (
    <section className="w-full bg-surface-page px-4 py-8 md:px-6 md:py-10 relative overflow-hidden">
      <GridPattern
        id="calendar-grid"
        ...
        <div className="flex items-center justify-between mb-5 md:mb-6">
          ...
          <div className="hidden sm:flex items-center text-[10px] font-mono font-bold uppercase tracking-widest">
            <button
              ...
              className="group flex items-center gap-2 text-ink-soft hover:text-accent-bright transition-colors duration-200 focus-visible:outline-none focus-visible:ring focus-visible:ring-accent rounded"
              aria-label="Scroll through the race calendar"
            >
              <span className="transition-colors duration-200 group-hover:text-ink-strong">
                Scroll
              </span>
              <svg
          ...
          <div className="flex gap-3 md:gap-4 min-w-min">
            {events.map((event) => {
              ...
              return (
                ...
                >
                  <div className="bg-surface-panel border border-line-soft rounded-sm overflow-hidden group hover:border-accent/50 transition-all duration-300 shadow-lg shadow-black/20">
                    <div className="p-3.5 md:p-4 flex flex-col items-center text-center">
                      {/* Top: Track Map Area (Flag removed from here) */}
                      <div className="relative w-full h-[4.5rem] md:h-20 mb-3 bg-surface-band/50 rounded-sm overflow-hidden border border-line-soft/30 flex items-center justify-center">
                        <ConcentricPattern
                      ...
                      <span className="text-[10px] font-mono font-bold text-accent-bright uppercase tracking-widest mb-1">
                        {isTesting
                          ? "Testing Session"
                      ...
                      <div className="flex items-center gap-2 mb-3 max-w-full">
                        ...
                        <h3 className="text-sm md:text-base font-bold text-ink-strong leading-tight line-clamp-1">
                      ...
                      <div className="flex flex-col items-center mb-3.5 md:mb-4">
                        <span className="text-3xl md:text-[2rem] font-bold text-ink-strong font-mono tracking-tighter leading-none">
                          {daysUntil}
                        </span>
                        <span className="text-[9px] font-bold text-ink-faint uppercase tracking-widest font-mono mt-1">
                          Days Remaining
                        </span>
                      </div>
                      ...
                      <div className="flex flex-col items-center gap-1 mb-4">
                        <div className="flex items-center gap-1.5 text-ink-base">
                          <svg
                            className="w-3 h-3"
                            fill="none"
                            stroke="currentColor"
                      ...
                      {/* CTA Footer */}
                      <div className="w-full pt-3 border-t border-line-soft/40 flex items-center justify-center">
                        {isNewCircuit && !isTesting ? (
                          <span className="text-[9px] font-bold font-mono tracking-widest uppercase text-accent-bright flex items-center gap-1.5">
                          ...
                          <Link
                            ...
                            className="text-[9px] font-bold font-mono tracking-widest uppercase text-ink-faint hover:text-accent-bright transition-colors flex items-center gap-1.5 group/btn"
                          >
                          ...
                          <span className="text-[9px] font-bold font-mono tracking-widest uppercase text-ink-soft">
                            Race Debrief Coming
                          </span>
                        )}
                      </div>

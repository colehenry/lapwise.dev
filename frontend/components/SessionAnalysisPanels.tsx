...
const LapTimeByLapGraph = dynamic(() => import("./LapTimeByLapGraph"), {
  loading: ChartFallback,
});
const QualifyingSpreadChart = dynamic(() => import("./QualifyingSpreadChart"), {
  loading: ChartFallback,
});
const TyreStintChart = dynamic(() => import("./TyreStintChart"), {
  loading: ChartFallback,
});
